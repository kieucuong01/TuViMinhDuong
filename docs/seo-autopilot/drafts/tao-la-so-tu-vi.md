...
**Intent:** Người đọc muốn tạo lá số tử vi online nhưng cần hiểu nên chuẩn bị ngày giờ sinh, giới tính và cách đọc kết quả.

## Keyword Evidence

Cluster: core-la-so-tu-vi
Cluster volume: 597130
Keyword count: 244
Average KD: 59

Top source keywords:
- lá số tử vi (volume 368000, KD 61)
- lập lá số tử vi (volume 74000, KD 59)
- tử vi lá số (volume 40500, KD 59)
- lá số tử vi trọn đời (volume 14800, KD 59)
- lấy lá số tử vi (volume 14800, KD 59)
- tạo lá số tử vi (volume 8100, KD 44)

**Meta title:** Tạo lá số tử vi: cách chuẩn bị ngày giờ sinh | Lá số tinh hoa

**Meta description:** Hướng dẫn tạo lá số tử vi theo hướng dễ hiểu: cần ngày sinh, giờ sinh, giới tính, lịch sinh nào, sai giờ sinh ảnh hưởng ra sao và nên đọc kết quả thế nào.

## Outline
- Tạo lá số tử vi là nhu cầu gì của người mới?
...
- Create a compact score table for tạo lá số tử vi: risk, stability, accumulation/relationship/career fit, and reading confidence.
...
expert prompt frame:
- Expert prompt frame for Tạo lá số tử vi: analyze by logic nhan qua from star/palace nature, activation condition, likely expression, limitation, then practical advice.
...
interactive CTA: Invite the reader to enter birth date/time to check whether tạo lá số tử vi appears in their chart and what palace/modifier context changes the reading.
interactive target: /#lap-la-so

## Cover Asset Requirements

Preferred file: public/articles/tao-la-so-tu-vi.webp
Public path: /articles/tao-la-so-tu-vi.webp
Format: webp
Dimensions: 1200x675
Subject: Create a photo-editorial cover for Tạo lá số tử vi: a believable real-world Vietnamese scene connected to tạo lá số tử vi, with a chart, paper la so, family/home/work object, or reading context visible.
...
## FAQ
- **Tạo lá số tử vi có cần giờ sinh chính xác không?**
...
- **Lá số miễn phí xem được những phần nào?**
...
- **Sau khi tạo lá số nên đọc bài nào trước?**
