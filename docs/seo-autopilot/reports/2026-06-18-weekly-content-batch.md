...
Generated: 2026-06-18T23:22:35.441Z
...
## Next Action
Next action: single_article_publish `sao-tu-vi`
Weekly batch: `sao-tu-vi`
Approval required: no
Reason: Publish 1 people-first articles from SEMrush intent clusters; first topic: Người đọc muốn hiểu ý nghĩa sao Tử Vi trong lá số và cách đọc theo cung.
## Warnings
- None
...
## Artifacts
- Batch draft: `docs/seo-autopilot/drafts/sao-tu-vi.md`
## Weekly Content Plan
- Monday: `sao-tu-vi` (top, 6500-9500 chars, cover /articles/sao-tu-vi.webp)
