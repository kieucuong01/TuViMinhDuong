...
Generated: 2026-06-13T07:02:31.740Z
...
- Status: unavailable
- Warning: OAuth refresh failed: Unauthorized
## Next Action
Next action: weekly_content_batch `la-so-bat-tu-va-tu-vi`
Weekly batch: `la-so-bat-tu-va-tu-vi`
Approval required: no
Reason: Publish 1 people-first articles from SEMrush intent clusters; first topic: Người đọc tìm lá số bát tự và cần phân biệt bát tự, tứ trụ với lá số tử vi trước khi chọn cách xem phù hợp.
## Warnings
- None
...
## Weekly Content Plan
- Monday: `la-so-bat-tu-va-tu-vi` (middle, 5500-8500 chars)
