...
import { CalendarDays, CheckCircle2, ChevronLeft, ChevronRight, Clock3, Compass, Sparkles, TriangleAlert, XCircle } from "lucide-react";
import { analyzeDate, formatDate, monthDays, parseInputDate, toInputDate, type FortuneTone } from "@/lib/date-fortune";
...
export function DateView() {
  ...
  const fortune = useMemo(() => analyzeDate(date), [date]);
    ...
    <div className="date-view-shell">
      <section className="date-hero-panel">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="eyebrow">Xem ngày</p>
            <h1 className="text-balance text-4xl font-black text-stone-950 md:text-5xl">Lịch ngày tốt xấu theo tử vi ứng dụng</h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-stone-600">
              Chọn ngày để xem cát hung, can chi, âm lịch, giờ hoàng đạo và gợi ý việc nên làm. Khi cần cá nhân hóa sâu hơn, hãy ghép với lá số của bạn.
            </p>
          </div>
        ...
        <div className="date-score-panel">
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              ...
              <span className="rounded-full bg-orange-50 px-3 py-1 text-sm font-black text-orange-700 ring-1 ring-orange-100">Trực {fortune.direct}</span>
              <span className="rounded-full bg-white px-3 py-1 text-sm font-black text-stone-600 ring-1 ring-stone-200">{fortune.star}</span>
            </div>
          </div>
          ...
          <section className="grid gap-6 md:grid-cols-2">
            <div className="panel">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-black text-stone-950">Nên làm</h2>
              </div>
            ...
            <div className="panel">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-black text-stone-950">Nên tránh</h2>
              </div>
              <ul className="mt-4 grid gap-2">
      ...
      <section className="mt-6 rounded-3xl border border-orange-100 bg-stone-950 p-6 text-white shadow-2xl shadow-stone-950/10">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="eyebrow text-orange-300">Cá nhân hóa</p>
            <h2 className="text-2xl font-black">Muốn biết ngày này hợp với riêng bạn không?</h2>
            <p className="mt-2 max-w-2xl text-stone-300">Lập lá số để ghép ngày đang xem với Mệnh, Thân, đại vận và nhật vận cá nhân.</p>
          </div>
