...
describe("SEO URL guards", () => {
  ...
  it("keeps noindex and non-self-canonical articles out of indexable sets", () => {
    ...
    expect(isSelfCanonicalArticle({ slug: "tu-vi-tron-doi-tuoi-ky-dau-1969-nam-mang", canonicalUrl: "/xem-tu-vi-tron-doi/tu-vi-tron-doi-tuoi-ky-dau-1969-nam-mang" })).toBe(true);
    expect(isSelfCanonicalArticle({ slug: "tu-vi-tron-doi-tuoi-ky-dau-1969-nam-mang", canonicalUrl: "/tu-vi-tron-doi-tuoi-ky-dau-1969-nam-mang" })).toBe(false);
