...
describe("SEO scoring", () => {
  it("rewards complete article metadata and structure", () => {
    const strong = scoreArticleSeo({
      title: "Cách đọc cung Mệnh trong tử vi cho người mới",
      slug: "cach-doc-cung-menh-trong-tu-vi",
      excerpt: "Tìm hiểu cách đọc cung Mệnh trong tử vi theo hướng ứng dụng, dễ hiểu và có thể kết hợp cùng cung Thân.",
      focusKeyword: "cung mệnh tử vi",
      metaTitle: "Cách đọc cung Mệnh trong tử vi cho người mới",
      metaDescription: "Tìm hiểu cách đọc cung Mệnh trong tử vi, các yếu tố cần xem cùng Cung Thân, chính tinh, phụ tinh và vận hạn.",
