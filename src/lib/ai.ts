...
- Actionable Advice: với báo cáo FULL, chỉ chương Kế hoạch hành động cá nhân tổng hợp việc nên làm và nên tránh; với phần mở khóa đơn lẻ, đặt hành động trong mục Gợi ý nên làm.
...
- Điểm nhấn: mỗi chương luận giải phải có 3-6 kết luận quan trọng viết bằng Markdown **in đậm**; chỉ in đậm cụm hoặc câu then chốt, không in đậm nguyên đoạn dài.
...
- Đánh dấu 3-6 kết luận quan trọng bằng **in đậm**; không in đậm nguyên đoạn.`;
...
**Điểm cần phòng:** giảm tốc khi thông tin, trách nhiệm hoặc giới hạn rủi ro chưa rõ.`;
}
