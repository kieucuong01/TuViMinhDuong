...
export type FeaturePriceMap = Record<ReadingKey, { label: string; priceCoins: number }>;

// Production paywall mode: paid readings require coins unless the user is an admin.
export const TEMPORARY_FULL_ACCESS = false;

export const FEATURE_PRICES: FeaturePriceMap = {
...
export const FEATURE_PRICE_KEYS = Object.keys(FEATURE_PRICES) as ReadingKey[];
