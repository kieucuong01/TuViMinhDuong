...
export type DateTaskKey = "general" | "wedding" | "opening" | "contract" | "travel" | "groundbreaking" | "houseMoving" | "vehiclePurchase" | "funeral";
...
const taskRules: DateTaskRule[] = [
  ...
  { key: "houseMoving", label: "Nhập trạch", description: "Ưu tiên ngày an cư, ổn định nền nhà và tránh các ngày phá bế.", goodDirects: ["Mãn", "Định", "Thành", "Khai"], badDirects: ["Phá", "Nguy", "Bế"], goodMansions: ["Thất", "Bích", "Lâu", "Vị", "Trương"], badMansions: ["Hư", "Nguy", "Liễu", "Dực", "Quỷ"] },
  { key: "vehiclePurchase", label: "Mua xe", description: "Ưu tiên ngày mua sắm, giao nhận tài sản và di chuyển thuận lợi.", goodDirects: ["Mãn", "Thành", "Thu", "Khai"], badDirects: ["Phá", "Nguy", "Bế"], goodMansions: ["Giác", "Đẩu", "Lâu", "Vị", "Tất", "Chẩn"], badMansions: ["Cang", "Đê", "Ngưu", "Mão", "Quỷ"] },
  { key: "funeral", label: "An táng", description: "Ưu tiên ngày tĩnh, thu xếp việc hiếu sự trang nghiêm và tránh ngày khai mở mạnh.", goodDirects: ["Trừ", "Thu", "Bế"], badDirects: ["Mãn", "Thành", "Khai"], goodMansions: ["Tất", "Quỷ"], badMansions: ["Phòng", "Trương", "Sâm", "Chẩn"] },
];
